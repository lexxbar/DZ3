...
Для того что бы работать с удаленными репозиториями (_те репозитории которые находятся вне нашего компьютера_) , нам необходимо зарегистрироваться на сервисе **GitHub**
